...
namespace Infrastructure
{
    public class KeyVaultResource : AbstractResource, IConfiguration
    {
        ...
        public KeyVaultResource(ResourceGroupResource resourceGroup, Output<string> tenantId)
        ...
        public void AddAccessPolicy(string accessPolicyName, Output<string>? principalId)
        {
