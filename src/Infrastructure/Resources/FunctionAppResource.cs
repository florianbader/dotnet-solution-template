...
public class FunctionAppResource : AbstractResource
{
    ...
    public void AddConfiguration(string key, Output<string>? value)
    {
        ...
        _appSettings.Add(new[] { new NameValuePairArgs { Name = key, Value = value } });
    }
    ...
    public void Build(AppServicePlanResource appServicePlanResource, StorageAccountResource storageAccountResource)
    {
        ...
        _appSettings.Add(new[] { new NameValuePairArgs { Name = "FUNCTIONS_EXTENSION_VERSION", Value = "~3" } });
        _appSettings.Add(new[] { new NameValuePairArgs { Name = "FUNCTIONS_WORKER_RUNTIME", Value = "dotnet" } });
        _appSettings.Add(new[] { new NameValuePairArgs { Name = "AzureWebJobsStorage", Value = storageAccountResource.ConnectionString } });
        _appSettings.Add(new[] { new NameValuePairArgs { Name = "WEBSITES_ENABLE_APP_SERVICE_STORAGE", Value = "false" } });
